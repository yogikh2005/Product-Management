...
<body class="" style="background: #e2e2e2;">
	<img src="<c:url value='/resource/img/yk.jpg' />" />
				...
				<div class="card">
					<div class="card-body">
						...
						<form action="handleform" method="post">
							...
							<div class="form-group">
								<label for="Id">Your Id</label> <input name="id"
									type="text" class="form-control" placeholder="Enter ID">
							</div>

							<div class="form-group">
								<label for="Date">Your DOB</label> <input
							...
							<div class="form-group">
								<label for="street">Your Street</label> <input
									name="address.street" type="text" class="form-control"
									placeholder="Enter Street">
							</div>
							
							<div class="form-group">
								<label for="city">Your City</label> <input
